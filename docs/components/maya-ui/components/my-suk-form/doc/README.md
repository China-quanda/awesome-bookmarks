...
该组件由 [vue-sku-form](https://hurui.me/vue-sku-form/) vue2版本改造为vue3版本 github地址：[vue-sku-form](https://github.com/hooray/vue-sku-form)
...
| [attribute](#attribute) | SKU已选属性      |    array |    [] |
| sku | SKU数据      |    array |    [] |
| separator | SKU字段分隔符      |    string |    ; |
| emptySku | 无属性SKU名称      |    array |     |
| disabled | 是否显示SKU选择栏      |    boolean |    false |
| theme | SKU选择栏主题风格，可选1或2      |    number |    1 |
...
| 名称        | 说明           | 类型  | 默认值  |
| :-------------: |:-------------:|:-----:| :-----:|
| name | 属性名称      |    string |    input |
| item | 属性可选项      |    array |  string   |
